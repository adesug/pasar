...
function ajaxkota(id){
  var url="http://restapi.xyz/sys/pasarin/daerah/getKab/"+id+"/"+Math.random();
...
function ajaxkec(id){
  var url="http://restapi.xyz/sys/pasarin/daerah/getKec/"+id+"/"+Math.random();
...
function ajaxkel(id){
  var url="http://restapi.xyz/sys/pasarin/daerah/getKel/"+id+"/"+Math.random();
