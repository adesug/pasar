<center><h1>ORDER DETAIL</h1></center>
    ...
    <a class="btn btn-primary btn-s float-right mb-3 ml-2" target="_blank" href="<?=base_url();?>order/orderCetak2/<?=$arrTrx->id?>" ><i class="fa fa-sticky-note" aria-hidden="true"></i> VIEW NOTA </a>    
    <a class="btn btn-primary btn-s float-right mb-3" target="_blank" href="<?=base_url();?>order/orderCetak/<?=$arrTrx->id?>" ><i class="fa fa-print" aria-hidden="true"></i> PRINT </a>    
...
<table id="example" class="table table-striped table-bordered" style="width:100%">
    ...
    <?php if($isRev){?>
        ...
        <?php } ?>
    <?php } ?>
        <tr><td colspan="7">Total</td><td><b class="bg-warning">Rp <?=number_format($totalAllPrice, 0, ',', '.') ?> ,-</b></i></td></tr>
</table>
