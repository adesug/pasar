...
"></center>
    ...
    <table class="table table-striped table-bordered " style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                <center>
                    <a class="btn btn-primary btn-xs" target="_blank" href="<?= base_url(); ?>order/orderCetak/<?= $arrTrx->id ?>">
                        <i class="fa fa-print" aria-hidden="true"></i> Print</a>
                    <a class="btn btn-primary btn-xs" target="_blank" href="<?= base_url(); ?>order/orderCetak2/<?= $arrTrx->id ?>">
                        <i class="fa fa-sticky-note" aria-hidden="true"></i> View Nota</a>
                </center>
            </td>
        </tr>
        <!-- </table>
        ...
        <tr>
            ...
            <td rowspan="2">
                <center>
                    <a class="btn btn-primary btn-xs" style="margin-top: 50px;" target="_blank" href="https://www.google.com/maps/search/?api=1&query=<?= $arrUser->lat; ?>,<?= $arrUser->long; ?>"><i class="fas fa-map-marker-alt"></i> Lihat Peta</a>
                    <a class="btn btn-primary btn-xs" style="margin-top: 50px;" target="_blank" href="https://www.google.com/maps/search/?api=1&query=<?= $arrUser->lat; ?>,<?= $arrUser->long; ?>"><i class="fas fa-map-marker-alt"></i> Kirim Peta Wahyu</a>
                    <a class="btn btn-primary btn-xs" style="margin-top: 50px;" target="_blank" href="https://www.google.com/maps/search/?api=1&query=<?= $arrUser->lat; ?>,<?= $arrUser->long; ?>"><i class="fas fa-map-marker-alt"></i> Kirim Peta Nur</a>
                </center>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3"><i class="bg-warning"> <strong>Catatan :</strong><br><?= $arrTrx->note; ?></i></td>
        </tr>
            ...
            <?php if ($isRev) { ?>
                ...
                <tr>
                    <td colspan="3"><?= $chart->name; ?> (<?= $chart->revTotal; ?> <?= $chart->revUnit; ?>) (Revisi)
                        <a class="btn btn-success btn-xs float-right" target="_blank" href="https://api.whatsapp.com/send?phone=<?= $mobPhone; ?>&text=Halo%20*kak%20<?= urlencode($arrUser->name) ?>%2C*%0A%0AMengkonfirmasikan%20terkait%20Order%20Nomor%20%3A%20*<?= $arrTrx->id ?>*%20*sudah%20siap%20diantar.*%20System%20sedang%20*menghubungkan%20dengan%20kurir%20terdekat.*%0A%0ATerimakasih%0A_Santi%2C_"><i class="fab fa-whatsapp"></i> WA-REVISI-OK </a>
    ...
    <table class="float-right">
        ...
        <tr>
            ...
            <!-- <a href=" #" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Total Bayar Rp.</a> -->
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <center>
                    <a href="<?= base_url(); ?>core/markAsShipped/<?= $arrTrx->id ?>" class="btn btn-primary btn-sm mt-3" style="width: 155px;"><i class="fas fa-hands-helping"></i>MARK AS SHIPPED</a>
                    <a href="<?= base_url(); ?>core/markAsComplete/<?= $arrTrx->id ?>" class="btn btn-success btn-sm mt-3" style="width: 155px;"><i class="fas fa-check-square"></i> MARK AS COMPLETE</a>
                    <a href="<?= base_url(); ?>core/markAsCancel/<?= $arrTrx->id ?>" class="btn btn-danger btn-sm mt-3" style="width: 155px;"><i class="fas fa-window-close"></i> MARK AS CANCEL</a>
                </center>
            </td>
        </tr>
    </table>

    <a class="btn btn-secondary btn-sm float-right ml-3" href=" <?= base_url(); ?>order/orderDetail/<?= $arrTrx->id ?>"> <i class="fa fa-file-invoice"></i> Detail Chart</a>

    <a class="btn btn-secondary btn-sm float-right ml-3 text-white" onclick="window.history.back();"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
    <br>
    <br>
    <br>